...
let mainMenuButtons = [ new Tile ("P1",0.2,0.2,0.1), new Tile ("P2",0.8,0.2,0.1), new Button("singleplayerGame",0.5,0.8,0.1), new Button("game",0.5,1.1,0.1), new Button("settingsMenu",0.5,1.4,0.1)];
var mainMenu = new Menu("Capitals", "mainMenu", mainMenuButtons);