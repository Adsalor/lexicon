...
let mainMenuButtons = [new Button("singleplayerGame",0.5,0.8,0.1), new Button("game",0.5,1.1,0.1), new Button("settingsMenu",0.5,1.4,0.1),new Switch("randoSwitch",0.75,1.65,0.1)];
