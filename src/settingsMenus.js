...
let settingsDisplays = [new Label("return to menu",0.15,0.2,50), new Label("Game Settings",0.5,0.8,50), new Label("Display Settings",0.5,1.1,50)];
...
let GSDisplays = [new Label("Come back later!",0.5,0.5,70),new Label("return to menu",0.15,0.2,50)];
...
let DSDisplays = [new Label("Dark Mode",0.3,0.5,50),new Label("return to menu",0.15,0.2,50)];
